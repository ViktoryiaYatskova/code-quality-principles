...
- Если логика одно из коммитов будет ошибочной, у вас будет быстро возможность сделать `revert` одного коммита, нежели по крупицам собирать куски кода неверной функциональности.
